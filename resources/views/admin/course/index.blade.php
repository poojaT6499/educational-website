                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{Request::root()}}/admin/Course/add-Course" class="btn btn-primary">+ Add
                                new</a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i}} </td>
                                            <td>{{ $CourseData->ClassTitle }}</td>
                                            <td>{{ $CourseData->CourseTitle }}</td>
                                            <td>{{ $CourseData->ChapterNos }}</td>
                                            <td>{{ $CourseData->TotalTime }}</td>
                                            <td>
                                                <a href="{{Request::root()}}/admin/Course/change-status-Course/{{ $CourseData->CourseID }}"
                                                    class="btn btn-sm btn-warning"> @if($CourseData->Status==1)
                                                    {{"Activate"}} @else {{"Dectivate"}} @endif </a>

                                                <a href="{{Request::root()}}/admin/Course/edit-Course/{{ $CourseData->CourseID }}"
                                                    class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                <a href="{{Request::root()}}/admin/Course/delete-Course/{{ $CourseData->CourseID }}"
                            ...
                            <div class="card card-profile">
                                <div class="card-header justify-content-end pb-0">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                            <div class="py-2">
                                                <a href="{{Request::root()}}/admin/Course/view-Course/{{ $CourseData->CourseID }}"
                                                    class="ml-4"> @if($CourseData->status==1) {{"Activate"}} @else
                                                    {{"Dectivate"}} @endif </a>
                                ...
                                <div class="card-body pt-2">
                                    <div class="text-center">
                                        <h3 class="mt-4 mb-1">{{ $CourseData->CourseTitle }}</h3>
