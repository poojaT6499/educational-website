        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-body">
                        <form role="form" method="post" action="{{Request::root()}}/admin/Chapter/edit-Chapter-post"
                            enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" value="<?php echo $Chapter->ChapterID ?>" name="ChapterID">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="IsLiveSession" value="1" <?php if($Chapter->IsLiveSession
                                == ""){ echo "checked"; } ?> >
                            </div>
                            <div class="form-group">
                                <label for="OrderNo">OrderNo:</label>
                                <input type="text" name="OrderNo" class="form-control" value="{{ $item->OrderNo }}">
