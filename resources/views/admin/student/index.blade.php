                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $student->phone }}</td>
                                            <td>
                                                <a href="{{ route('admin.student.edit', $student) }}" class="btn btn-sm btn-warning"><i class="la la-pencil"></i></a>
                                                <a href="{{ route('admin.student.delete', $student) }}" onclick="return confirm('are you sure to delete')" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                            </td>
                                        </tr>
