                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{Request::root()}}/admin/question/add-question" class="btn btn-primary">+ Add
                                new</a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i}} </td>
                                            <td>{{ $questionData->chapterID }}</td>
                                            <td>{{ $questionData->orderID }}</td>
                                            <td>{{ $questionData->questionTitle }}</td>
                                            <td>{{ $questionData->questionType }}</td>
                                            <td>{{ $questionData->courseID }}</td>
                                            <td>
                                                <a href="{{Request::root()}}/admin/question/change-status-question/{{ $questionData->questionID }}"
                                                    class="btn btn-sm btn-warning"> @if($questionData->status==1)
                                                    {{"Activate"}} @else {{"Dectivate"}} @endif </a>

                                                <a href="{{Request::root()}}/admin/question/edit-question/{{ $questionData->questionID }}"
                                                    class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                <a href="{{Request::root()}}/admin/question/delete-question/{{ $questionData->questionID }}"
                            ...
                            <div class="card card-profile">
                                <div class="card-header justify-content-end pb-0">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                            <div class="py-2">
                                                <a href="{{Request::root()}}/admin/question/view-question/{{ $questionData->questionID }}"
                                                    class="ml-4"> @if($questionData->status==1) {{"Activate"}} @else
                                                    {{"Dectivate"}} @endif </a>
                                ...
                                <div class="card-body pt-2">
                                    <div class="text-center">
                                        <h3 class="mt-4 mb-1">{{ $questionData->questionTitle }}</h3>
