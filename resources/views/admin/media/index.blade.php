                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{Request::root()}}/admin/Media/add-Media" class="btn btn-primary">+ Add
                                new</a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i}} </td>
                                            <td>{{ $MediaData->ChapterID }}</td>
                                            <td>{{ Str::substr($MediaData->MediaType,0,10) }}</td>
                                            <td>{{ Str::substr($MediaData->MediaUrl,0,20) }}</td>
                                            <td>{{ Str::substr($MediaData->MediaTitle,0,20) }}</td>
                                            <td>{{ Str::substr($MediaData->MediaSubTitle,0,20) }}</td>
                                            <td>
                                                <a href="{{Request::root()}}/admin/Media/change-status-Media/{{ $MediaData->MediaID }}"
                                                    class="btn btn-sm btn-warning"> @if($MediaData->Status==1)
                                                    {{"Activate"}} @else {{"Dectivate"}} @endif </a>

                                                <a href="{{Request::root()}}/admin/Media/edit-Media/{{ $MediaData->MediaID }}"
                                                    class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                <a href="{{Request::root()}}/admin/Media/delete-Media/{{ $MediaData->MediaID }}"
                            ...
                            <div class="card card-profile">
                                <div class="card-header justify-content-end pb-0">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                            <div class="py-2">
                                                <a href="{{Request::root()}}/admin/Media/view-Media/{{ $MediaData->MediaID }}"
                                                    class="ml-4"> @if($MediaData->Status==1) {{"Activate"}} @else
                                                    {{"Dectivate"}} @endif </a>
                                ...
                                <div class="card-body pt-2">
                                    <div class="text-center">
                                        <h3 class="mt-4 mb-1">{{ $MediaData->MediaType }}</h3>
